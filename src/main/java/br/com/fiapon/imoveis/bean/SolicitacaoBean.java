...
public class SolicitacaoBean {
	...
	public void cadastrar() {
		...
		// Mensagem que será associada ao componente h:h:messages – Por ser um
		// simulação, não está internacionalizado
	...
	// Retorna uma lista de comodos para a página xhtml, tratando
	// internacionalização
